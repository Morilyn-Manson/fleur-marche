...
export default function GalleryPage() {
    ...
    const galleryItems = [
        ...
        { src: '/images/bouquet/bouquet18.jpg', category: 'BOUQUET', alt: 'Bouquet 17', layoutClass: 'md:col-span-1 md:row-span-1' },
        { src: '/images/bouquet/bouquet19.jpg', category: 'BOUQUET', alt: 'Bouquet 17', layoutClass: 'md:col-span-1 md:row-span-1' },
        { src: '/images/bouquet/bouquet20.jpg', category: 'BOUQUET', alt: 'Bouquet 17', layoutClass: 'md:col-span-1 md:row-span-1' },
        { src: '/images/bouquet/bouquet21.jpg', category: 'BOUQUET', alt: 'Bouquet 17', layoutClass: 'md:col-span-1 md:row-span-1' },
        { src: '/images/bouquet/bouquet22.jpg', category: 'BOUQUET', alt: 'Bouquet 17', layoutClass: 'md:col-span-1 md:row-span-1' },
        { src: '/images/bouquet/bouquet23.jpg', category: 'BOUQUET', alt: 'Bouquet 17', layoutClass: 'md:col-span-1 md:row-span-1' },
        { src: '/images/bouquet/bouquet24.jpg', category: 'BOUQUET', alt: 'Bouquet 17', layoutClass: 'md:col-span-1 md:row-span-1' },
        { src: '/images/bouquet/bouquet25.jpg', category: 'BOUQUET', alt: 'Bouquet 17', layoutClass: 'md:col-span-1 md:row-span-1' },
        { src: '/images/bouquet/bouquet26.jpg', category: 'BOUQUET', alt: 'Bouquet 17', layoutClass: 'md:col-span-1 md:row-span-1' },
        { src: '/images/bouquet/bouquet27.jpg', category: 'BOUQUET', alt: 'Bouquet 17', layoutClass: 'md:col-span-1 md:row-span-1' },
        { src: '/images/bouquet/bouquet28.jpg', category: 'BOUQUET', alt: 'Bouquet 17', layoutClass: 'md:col-span-1 md:row-span-1' },
        { src: '/images/bouquet/bouquet29.jpg', category: 'BOUQUET', alt: 'Bouquet 17', layoutClass: 'md:col-span-1 md:row-span-1' },
        { src: '/images/bouquet/bouquet30.jpg', category: 'BOUQUET', alt: 'Bouquet 17', layoutClass: 'md:col-span-1 md:row-span-1' },
        { src: '/images/bouquet/bouquet31.jpg', category: 'BOUQUET', alt: 'Bouquet 17', layoutClass: 'md:col-span-1 md:row-span-1' },
        { src: '/images/bouquet/bouquet32.jpg', category: 'BOUQUET', alt: 'Bouquet 17', layoutClass: 'md:col-span-1 md:row-span-1' },
        { src: '/images/bouquet/bouquet33.jpg', category: 'BOUQUET', alt: 'Bouquet 17', layoutClass: 'md:col-span-1 md:row-span-1' },
        { src: '/images/bouquet/bouquet34.jpg', category: 'BOUQUET', alt: 'Bouquet 17', layoutClass: 'md:col-span-1 md:row-span-1' },
        { src: '/images/bouquet/bouquet35.jpg', category: 'BOUQUET', alt: 'Bouquet 17', layoutClass: 'md:col-span-1 md:row-span-1' },
        ...
        { src: '/images/arrengement/arrengement19.jpg', category: 'ARRANGEMENT', alt: 'Arrangement 18', layoutClass: 'md:col-span-2 md:row-span-2' },
        { src: '/images/arrengement/arrengement20.jpg', category: 'ARRANGEMENT', alt: 'Arrangement 18', layoutClass: 'md:col-span-2 md:row-span-2' },
        { src: '/images/arrengement/arrengement21.jpg', category: 'ARRANGEMENT', alt: 'Arrangement 18', layoutClass: 'md:col-span-2 md:row-span-2' },
        { src: '/images/arrengement/arrengement22.jpg', category: 'ARRANGEMENT', alt: 'Arrangement 18', layoutClass: 'md:col-span-2 md:row-span-2' },
        { src: '/images/arrengement/arrengement23.jpg', category: 'ARRANGEMENT', alt: 'Arrangement 18', layoutClass: 'md:col-span-2 md:row-span-2' },
        { src: '/images/arrengement/arrengement24.jpg', category: 'ARRANGEMENT', alt: 'Arrangement 18', layoutClass: 'md:col-span-2 md:row-span-2' },
        { src: '/images/arrengement/arrengement25.jpg', category: 'ARRANGEMENT', alt: 'Arrangement 18', layoutClass: 'md:col-span-2 md:row-span-2' },
        { src: '/images/arrengement/arrengement26.jpg', category: 'ARRANGEMENT', alt: 'Arrangement 18', layoutClass: 'md:col-span-2 md:row-span-2' },
        { src: '/images/arrengement/arrengement27.jpg', category: 'ARRANGEMENT', alt: 'Arrangement 18', layoutClass: 'md:col-span-2 md:row-span-2' },
        { src: '/images/arrengement/arrengement28.jpg', category: 'ARRANGEMENT', alt: 'Arrangement 18', layoutClass: 'md:col-span-2 md:row-span-2' },
        { src: '/images/arrengement/arrengement29.jpg', category: 'ARRANGEMENT', alt: 'Arrangement 18', layoutClass: 'md:col-span-2 md:row-span-2' },
        { src: '/images/arrengement/arrengement30.jpg', category: 'ARRANGEMENT', alt: 'Arrangement 18', layoutClass: 'md:col-span-2 md:row-span-2' },
        { src: '/images/arrengement/arrengement31.jpg', category: 'ARRANGEMENT', alt: 'Arrangement 18', layoutClass: 'md:col-span-2 md:row-span-2' },
        { src: '/images/arrengement/arrengement32.jpg', category: 'ARRANGEMENT', alt: 'Arrangement 18', layoutClass: 'md:col-span-2 md:row-span-2' },
        { src: '/images/arrengement/arrengement33.jpg', category: 'ARRANGEMENT', alt: 'Arrangement 18', layoutClass: 'md:col-span-2 md:row-span-2' },
        { src: '/images/arrengement/arrengement34.jpg', category: 'ARRANGEMENT', alt: 'Arrangement 18', layoutClass: 'md:col-span-2 md:row-span-2' },
        { src: '/images/arrengement/arrengement35.jpg', category: 'ARRANGEMENT', alt: 'Arrangement 18', layoutClass: 'md:col-span-2 md:row-span-2' },
